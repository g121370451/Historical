...
namespace experiment
{
    namespace result
    {
        struct basicData
        {
         ...
         // 对齐缓存行的分片数据单元
        struct alignas(64) MaintainShard {
            int label_count_slot1 = 0;
            int label_count_slot2 = 0;
            int queue_count_slot1 = 0;
            int queue_count_slot2 = 0;
            int cover_count_slot1 = 0;
            int cover_count_slot2 = 0;
            int ppr_insert_slot1 = 0;
            int ppr_insert_slot2 = 0;
            int label_decrease_insert_slot1 = 0;
            int label_increase_insert_slot1 = 0;
            int label_decrease_insert_slot2 = 0;
            int label_increase_insert_slot2 = 0;
            int prune_count_slot1 = 0;
            int prune_count_slot2 = 0;
            int diffuse_count_slot1 = 0;
            int diffuse_count_slot2 = 0;
        };
        ...
        static_assert(sizeof(MaintainShard) == 64, "Maintain MethodShard size mismatch");
    ...
    // 分片计数器管理器（固定线程数优化版）
        ...
        struct MethodData {
            ...
            int total_label_count() const noexcept;
            int total_queue_count() const noexcept;
            int total_cover_count() const noexcept;
            int total_ppr_insert_count() const noexcept;
            int total_increase_label_insert_count() const noexcept;
            int total_decrease_label_insert_count() const noexcept;

            int total_prune_count() const noexcept;
            int total_diffuse_count() const noexcept;

            operator MaintainShard&();
        };  
        ...
        void init_config(const std::string &dataset,const int threadNum);
