...
void experiment::result::init_config(const std::string strategy, const std::string &dataset, int thread_count,
                                     int iteration_count, int change_count, int hop_limit) {
