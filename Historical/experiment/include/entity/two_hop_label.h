...
namespace experiment
{
	...
	namespace nonhop
	{
		...
		template <typename weight_type>
		std::pair<int, int> graph_weighted_two_hop_extract_distance_and_hub_in_current_with_csv(std::vector<two_hop_label<weight_type>> &L_s,
																								std::vector<two_hop_label<weight_type>> &L_t, int source, int terminal,
		...
		template <typename weight_type>
		std::pair<int, int> search_sorted_two_hop_label_in_current_with_csv(std::vector<two_hop_label<weight_type>> &input_vector, int key, experiment::result::MaintainShard &maintain_shard)
		{
			if (experiment::status::currentTimeMode == experiment::status::MaintainTimeMode::SLOT1)
			{
		...
		void insert_sorted_two_hop_label(std::vector<two_hop_label<weight_type>> &input_vector, int key, int value, int time, experiment::result::MaintainShard &maintain_shard)
		{
			...
			while (left <= right)
			{
				...
				if (input_vector[mid].t_e == std::numeric_limits<int>::max())
				{
					if (input_vector[mid].vertex == key)
					{
						two_hop_label<weight_type> old_label = input_vector[mid];
			...
			if (value != MAX_VALUE)
			{
				two_hop_label<weight_type> new_label(time);
		...
		public:
			...
			bool operator==(const two_hop_case_info<weight_type> &other) const
			{
			...
			void serialize(std::ofstream &out) const
			{
				...
				for (auto &item : L)
				{
					BinarySerializer<std::vector<experiment::nonhop::two_hop_label<weight_type>>>::saveBinary(out, item);
					out.flush();
				}
			...
			void deserialize(std::ifstream &in)
			{
				...
				for (auto &item : L)
				{
					BinarySerializer<std::vector<experiment::nonhop::two_hop_label<weight_type>>>::loadBinary(in, item);
				}
			...
			{
				long long int res = 0;
				for (const std::vector<experiment::nonhop::two_hop_label<weight_type>> &L_info : L)
				{
					for (const experiment::nonhop::two_hop_label<weight_type> &inner : L_info)
					{
						++res;
					}
				}
			...
			long long int compute_L_byte_size()
			{
				...
				{
					size = size + (*it).size() * sizeof(two_hop_label<weight_type>); // 12 byte per two_hop_label
				}
				return size;
			}
	...
	namespace hop
	{
		...
		template <typename weight_type>
		inline experiment::hop::two_hop_label<weight_type>::two_hop_label() : t_s(0), t_e(std::numeric_limits<int>::max())
		{
			hub_vertex = 0;
			hop = 0;
			distance = std::numeric_limits<weight_type>::max();
		...
		// template <typename weight_type>
		// std::pair<weight_type, int> hop_constrained_extract_distance_and_hub(std::vector<std::vector<two_hop_label<weight_type>>> &L, int source, int terminal, int hop_cst)
		// {
		...
		// template <typename weight_type>
		// std::pair<weight_type, int> hop_constrained_extract_distance_and_hop(std::vector<std::vector<two_hop_label<weight_type>>> &L, int source, int terminal, int hop_cst)
		// {
		// 	/*return std::numeric_limits<int>::max() is not connected*/
		...
		// template <typename weight_type>
		// std::tuple<weight_type, int, int> graph_weighted_two_hop_extract_distance_and_hop_and_hub_by_backup_label(std::vector<two_hop_label<weight_type>> &L_s, std::vector<two_hop_label<weight_type>> &L_t, int hop_cst)
		// {
		// 	/*return std::numeric_limits<int>::max() is not connected*/
		...
		// template <typename weight_type>
		// std::pair<weight_type, int> graph_weighted_two_hop_extract_distance_and_hop_by_backup_label(std::vector<two_hop_label<weight_type>> &L_s, std::vector<two_hop_label<weight_type>> &L_t, int hop_cst)
		// {
		// 	/*return std::numeric_limits<int>::max() is not connected*/
		...
		// }
		// template <typename weight_type>
		// std::pair<weight_type, int> graph_weighted_two_hop_extract_distance_and_hub_by_backup_label(std::vector<two_hop_label<weight_type>> &L_s, std::vector<two_hop_label<weight_type>> &L_t, int hop_cst)
		// {
		// 	/*return std::numeric_limits<int>::max() is not connected*/
		...
		// template <typename weight_type>
		// weight_type search_sorted_hop_constrained_weight_two_hop_label(std::vector<two_hop_label<weight_type>> &input_vector, int key, int hop)
		// {
		// 	int left = 0, right = input_vector.size() - 1;
		...
		// }
		// template <typename weight_type>
		// two_hop_label<weight_type> search_sorted_hop_constrained_label_two_hop_label(std::vector<two_hop_label<weight_type>> &input_vector, int key, int hop)
		// {
		// 	int left = 0, right = input_vector.size() - 1;
		...
		// }
		// template <typename weight_type>
		// std::pair<weight_type, int> get_shortest_distance_hop_two_hop_label2(std::vector<two_hop_label<weight_type>> &input_vector, int key)
		// {
		// 	int left = 0, right = input_vector.size() - 1;
		...
		// template <typename weight_type>
		// std::pair<weight_type, int> get_shortest_distance_hop_two_hop_label2(std::vector<two_hop_label<weight_type>> &input_vector, int key, int hop_k)
		// {
		// 	int left = 0, right = input_vector.size() - 1;
		...
		// template <typename weight_type>
		// void insert_sorted_hop_constrained_two_hop_label(std::vector<two_hop_label<weight_type>> &input_vector, int key, int hop, weight_type new_distance, int t)
		// {
		// 	int left = 0, right = input_vector.size() - 1;
		...
		// template <typename weight_type>
		// std::pair<weight_type, int> search_sorted_hop_constrained_weight_and_index_two_hop_label(std::vector<two_hop_label<weight_type>> &input_vector, int key, int hop)
		// {
		// 	int left = 0, right = input_vector.size() - 1;
